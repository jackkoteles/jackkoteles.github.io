      ...
      <section id="about" className="about">
        <div className="about-content">
          ...
          <div className="paragraph-text">
            Hello, and welcome! I'm Jack and I am currently a sophomore at the University of 
            Wisconsin-Madison studying Computer Science and Data Science, with a certificate in consulting. Through my coursework and 
            projects I have gained experience in software development, data analysis, and machine learning. Additionally on campus, I am 
            an active member of our dotData and AI@UW organizations. I am passionate about using data and technology to solve 
            problems and answer questions.
          </div>
          <div className="paragraph-text">
            Outside of the classroom, I love sports, specifically football and the Chicago Bears. However,
          ...
          <div className="paragraph-text">
            Thanks for visiting! Feel free to check out some of my work below or reach out.
          </div>
        </div>
